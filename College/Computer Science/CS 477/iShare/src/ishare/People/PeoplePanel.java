 ...
 * 
 *///===========================================================================
public class PeoplePanel extends TitledPanel {
	
  private JPanel peoplePanel = null;
  private JPanel peopleButtonPanel = null;
  
	//--------------------------------------------------------------------------
	public PeoplePanel( JFrame containedBy, JPanel contextPanel ){
	...
	protected JPanel buildNavigationPanel(){
		...
		forwardButton = new StandardButton( "Add Person" );
		forwardButton.setActionCommand( "Add Person" );
		forwardButton.addActionListener( this );
		if( containedBy.personCollection.isFull() ){
...
//	  thisPanel.add( pictureLabel, BorderLayout.NORTH );
	...
	public void actionPerformed( ActionEvent e ){
		...
		if ( e.getActionCommand().equals( "Back" ) ){
			...
			containedBy.switchToAddPersonPanel(this);
		...
		//goto the specified person's PersonInfoPanel	
			...
			Person person = containedBy.personCollection.get( b.getText() );
			containedBy.switchToPersonInfoPanel( this, person );
		}
	}
