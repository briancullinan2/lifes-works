...
public class ChoresEditPanel extends TitledPanel implements DocumentListener  {
  ...
  private JPanel iconPanel = null;
    ...
    // Class Constructor(s)
    public ChoresEditPanel( JFrame containedBy, JPanel contextPanel, Chore chore )
    {
    ...
    protected JPanel buildNavigationPanel()
    {
        ...
        titleLabel = new JLabel( "Edit a Existing Chore" );
        titleLabel.setHorizontalAlignment( SwingConstants.CENTER );
        titleLabel.setFont( titleFont );
        thisPanel.add( titleLabel, BorderLayout.CENTER );

        forwardButton = new StandardButton( "Save Changes" );
        forwardButton.setActionCommand( "Save Changes" );
    ...
    private JPanel buildNameEntryPanel(){
        ...
        currentChore = containedBy.choreCollection.findByTitle(title);
        icon = currentChore.getIcon();
        ...
        titleTextField = new TextHilight( currentChore.getTitle() );
    ...
    private JPanel buildDescriptionEntryPanel()
    {
        ...
        descTextArea = new TextAreaHilight( currentChore.getDescription() );
    ...
    public void checkCompletedForm(){
        ...
        debugOutput( "AddPersonPanel:   nameFieldText: " + titleFieldText );
        if( ( !titleFieldText.equals( "" ) ) &&
                ...
                debugOutput( "AddPersonPanel:   name set to: " + title );
        }
        ...
        if( chorePictureLabel != null ){
            ...
            // •• check to see if new values were entered if not, keep forwardbutton
            //    disabled
    ...
    public void actionPerformed(ActionEvent e) {
		...
		//the user has clicked the add person button after completing the form
                    ...
                    containedBy.choreCollection.remove(currentChore.getTitle());
                    currentChore.setTitle(title);
                    currentChore.setDescription(descTextArea.getText());
                    currentChore.setIcon(icon);
                    containedBy.choreCollection.addChore(currentChore);
                    containedBy.switchToContextPanel(contextPanel);
